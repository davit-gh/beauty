...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Prices'
        db.create_table(u'main_prices', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('col2', self.gf('mezzanine.core.fields.RichTextField')(blank=True)),
            ('col3', self.gf('mezzanine.core.fields.RichTextField')(blank=True)),
        ))
        db.send_create_signal(u'main', ['Prices'])


    def backwards(self, orm):
        # Deleting model 'Prices'
        db.delete_table(u'main_prices')
    ...
    models = {
        ...
        u'main.prices': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Prices', '_ormbases': [u'pages.Page']},
            'col2': ('mezzanine.core.fields.RichTextField', [], {'blank': 'True'}),
            'col3': ('mezzanine.core.fields.RichTextField', [], {'blank': 'True'}),
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'main.slide': {
